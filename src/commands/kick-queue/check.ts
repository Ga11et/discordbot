...
function buildKickQueueMessageContent(
  ...
  const parts = [
    "🔔 Приветик 🔔",
    "",
    "Это важное сообщение! :ghost:",
    "",
    "Это плановая очистка неактивных аккаунтов и незаинтересованных пользователей, которая проводится раз в 6–12 месяцев :heart_hands:",
    "",
    "Ты был(а) поставлен(а) в очередь на кик с сервера ***Julianne`s***, но без паники :hugging:",
    "",
    'Чтобы остаться - нажми кнопку *`"Остаться"`*',
    'Если тебе больше не интересен сервер - можешь проигнорировать это сообщение или прожать кнопку *`"Игнорировать"`*',
    "",
    ":hourglass_flowing_sand: На ответ дается **7 дней**. По истечении недели, **ровно в это же время**, все неактивные участники будут удалены",
    "",
    'Если возникла ошибка (н-р, ты прожал(а) кнопку *`"Остаться"`*, но тебя выкинуло с сервера) или при желании вернуться на сервер - пиши владельцу в личные сообщения: **||juliannemre||**',
    "Без проблем и вопросов предоставлю доступ-ссылку",
  ];
